...
class PipelineRunner:
    ...
    def _candidate_to_dict(self, candidate: SearchCandidate) -> dict[str, object]:
        return {
            ...
            "linked_source_page_url": candidate.linked_source_page_url,
            "linked_source_page_domain": candidate.linked_source_page_domain,
    ...
    def _failure_result(
        ...
        *,
        ...
        return PipelineResult(
            ...
            source_pages=outcome.source_pages,
    ...
    def _process(self, author: AuthorRecord) -> PipelineResult:
        ...
        self._log_step(
            ...
            source_pages=len(outcome.source_pages),
